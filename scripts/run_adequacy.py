...
# Scenario validation is structural: the declarative flag registry
# (clever/scenario/registry.py) accepts any string whose tokens are all declared
# flags — declaring a flag once is enough, no whitelist to edit.
from clever.scenario.registry import validate as _scn_validate  # noqa: E402
assert _scn_validate(SCENARIO), (
