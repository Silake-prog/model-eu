"""pommes_eur.data._inputs_clever — CLEVER case-study input tables.

CLEVER technology maps, EOLES cost & lifetime tables, PEMMDB hydro capacities, VRE profile
specs/fallbacks, BESS specs, EU interconnection NTCs and area mappings. Split verbatim out
of data/inputs.py (values byte-identical, guarded by tests/golden); re-exported via the
data.inputs facade. When a non-CLEVER provider (e.g. ERAA) is built, it supplies its own
equivalents. No numerics changed.
"""
